...
/**
 * Composant LineChart qui affiche un graphique linéaire des durées moyennes des sessions
 * @component
 * @param {Object} props - Propriétés du composant
 * @param {number} props.userId - ID de l'utilisateur dont les données sont à afficher
 * @returns {React.ReactElement} Composant LineChart
 */
const LineChart = ({ userId }) => {
  ...
  return <>{isLoading ? <Loader /> : <div id="line-chart" className="line-chart"></div>}</>
}
